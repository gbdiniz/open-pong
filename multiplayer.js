...
function gameLoop(timestamp) {
    ...
    if(isMulti && isTwoHolding && attackTwoPressed) {
        isTwoHolding = false;
        ballSpeedX = ofBallSpeedX;
        ballSpeedY = velBallY;
    } else if(!isMulti && isTwoHolding) {
        ballSpeedX = -ofBallSpeedX;
        ballSpeedY = velBallY;
    } else {
        //ok
...
document.addEventListener('keydown', (e) => {
    ...
    if (e.ctrlKey) { // Verifica se tecla "control" está sendo pressionada
